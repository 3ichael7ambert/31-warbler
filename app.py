...
def test_route():
    ...
    message1 = Message(text='Hello, Warbler!', user=user1)
    message2 = Message(text='Nice to meet you!', user=user2)
    
    # Add the users and messages to the database
    ...
    user1.followers.append(user2)  # user2 follows user1
    user2.followers.append(user1)  # user1 follows user2
    user1.likes.append(message2)   # user1 likes message2
    
    # Print the relationships
    print(user1.followers)         # Print the followers of user1
    print(user1.likes)             # Print the messages liked by user1
    
    return 'Testing relationships'
